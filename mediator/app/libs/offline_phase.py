...
class OfflinePhase(metaclass=Singleton):
    ...
    def protocol_two(self, data):
        encrypted_user_item_matrix, encrypted_mask, start = data
        self.copy_arrays(encrypted_user_item_matrix, encrypted_mask, start)
    ...
    def copy_arrays(self, arr, arr2, start):
